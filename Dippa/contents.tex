...
with 15,12 occurrences, and also, they were both considered important. Defect
count, customer satisfaction and work in progress metrics occurred 8,6,6 times
respectively. Number of unit tests, lead time and check-ins per day occurred
5,4,3 times. Technical debt, build status and cycle time occurred 2 times.
...
\fixme{Lisää summary resulteista. tai metateksti}
...
\fixme{Viittaukset RQ:eiden vastaukssin}

\section{Focus of agile metrics}
...
Measure the product and the process, but not the people. Based on the metric
categorization by \citetsrc{fenton1998software} in
\Cref{tab:metricsCategorization}, measurement is focused towards Products and
...
drive dysfuntional behaviour. It seems agile methods don't give any special
...
measure me, and I will tell you how I will behave", which sums the complexity
of metric use.
...
from short-term context driven 'diagnostics'. Both types of metrics were also seen in this
study.

Metrics are a common tool for process improvement, but maybe this type of
creation of custom metrics is something new? \citetsrc{grady1992practical}
identifies failure and defect metrics as tools for process improvement.

\subsection{Reasons for metric use}

\fixme{Muuta tää korkeemman tason selitykseksi taulukosta}
Finding 4: The categories for reasons and effects for metric use can be seen
in \Cref{tab:whyCategories} and \Cref{tab:howCategories}. This answers the
question why metrics are used in industrial agile development. If we then
compare how these found reasons compare to reasons mentioned by others. Found
category 'Planning' is found in other literature as Project estimation
...
traditional metrics, for example frequent deliveries to customer?
...
development is more centered on the people, and metrics are used as
a tool for continuous improvement. 

There were also reasons that were not found in this study, such as
``Experimental validation of best practices'' \citep{312034}, ``Alignment of
software development to business objectives''
\citepsrc{pulford1995quantitative}, and `` The software development process
should be designed by measurable objectives, which leads to a precise
definition of software quality attributes.'' \citepsrc{zuse1998framework}.
Instead of deficing precise quality attributes, agile developers tend to
...
These benefits and reasons for metric use seem to  from the core
activities in agile development, implementation and testing. \fixme{mistä tää
on}
...
\section{Characteristics of important metrics}
...
and customer satisfaction being top 4 in terms of evidence of use and
...
post-release quality (customer satisfaction). \citetsrc{Korhonen2009} found in her study that traditional defect
...
measure of progress - which was also seen in this study. However, a key metric
for business value a team should define with business unit, proposed by
...
\fixme{Täydennä tätä uusilla havainnoilla. Vaatii että kattoo prinsiipit
uusiks.}
