...
software metric. Third, \cref{sec:systematicLiteratureReview} describes the
used research method, Systematic Literature Review.
...
\citetsrc{fenton1998software}, we use metrics everyday to, understand, control
and improve what we do and how we do it. According to
...
development and maintenance. \citetsrc{pulford1995quantitative} describes the
