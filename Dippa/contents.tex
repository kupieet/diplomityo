...
was used as a measure of progress [S12]. Number of written and passed unit
tests was used as a measure of progress in terms of completed work [S5].
Breaking down tasks to 'kits' between 2 to 5 days enabled progress monitoring
[S17]. Set of metrics(burndown, check-ins per day, number of written and
passed unit tests) was developed to manage risks and provide timely progress
monitoring [S27]. Story percent complete metric was used to give assessment of
...
day, number of written and passed unit tests) were used to communicate
...
day, number of written and passed unit tests) were used
...
written and passed unit tests), were used to increase product quality [S28].
...
Using number of written and passed unit tests dealt with decreasing the risk
that the product would be un-thoroughly tested [S5]. Similarly, number of
written and passed unit tests was used to make sure regression tests are ran and
passed every iteration [S5]. Story percent complete metric supports test
...
earlier beta version and making testing phases parallel. Many of the improvement ideas came from
...
Metrics were used to change people's behaviour. After meetings where technical
...
\fixme{Add SLR vs survey - eli pˆhkˆ tutkimusmenetelm‰ valittu teht‰v‰‰n}
