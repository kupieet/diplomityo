...
fundamental units of development for the iteration [S6].
...
Mamdas was measuring check-ins per day metric, which measured how often code
is committed to main trunk. The point was to avoid people from committing only at
...
At T-Systems International, they used a set of metrics(build status, number
...
Build status was measured to prevent defects reaching production environment.
[S14]
