...
Finding 1: Metrics can have negative effects. (Mut tää ei oo uutta tietoa.
Joku sanoi että ``Tell me how you will measure so I know how to act'' tjms.
...
mittarointikulttuurilta. Toisaalta tällaisista negatiivisista vaikutuksista
ei ollut oikein kuin yksi tapaus. Mutta toisaalta se oli vahvaa näyttöä, ja
uskoisin että negatiivista käyttöä harvoin raportoidaan tutkimuksissa,
päinvastoin.) Ydinmittarilla voi olla negatiivisia vaikutuksia.


Finding 2: Tilannesidonnaisten mittareiden merkitys. Havaittu muutamia
...
Finding 3: Tärkeiden mittareiden ominaisuuksia havaittu: helppokäyttöinen,
...
tarkastella monelta kantilta. Monet samat syyt voi perustella tärkeyden. 


Finding 4: Mittaroinnin syyt vs mitä muualla sanottu mittaamisen syyksi.
...
Finding 5: Tärkeitä mittareita nimetty. Kahdelta kantilta arvioitu. jeejee.
...
Finding 6: The use of code metrics: quite low, but there are some: tech debt,
violations. Kitchenham:n tutkimuksessa näkyi paljon koodimittareita, näissä ei
...
Finding 7: Prosesseja mittaavat mittarit mittaavat pääsiassa vain
...
Finding 8: Lähes kaikki mittarit mittaavat asioita 'sisäisesti', vain valmista
...
Finding 9: Resurssiluokan entiteettejä ei juurikaan mitata. Miksi ei?
...
Finding 10: Mittareiden sijoittumisesta menetelmiin: velocityä käytettiin
