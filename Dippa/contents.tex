...
\fixme{Tänne pitäis saada vielä lisää tekstiä. Ongelma ehkä on se, että dataa
ei synthetisoitu liittyen mittareihin, eikä tärkeisiin mittareihin. Joten
niiden syntetisoinnista en voi sanoa mitään. Toisaalta yksi kommentti oli,
että pitäisi lisätä taulukko important mittareista\ldots Mitenköhän sen saan?}

\begin{figure}
	\includegraphics{images/WhyMapExample}
	\centering
...
Research Question 2: \emph{Why are metrics used in industrial
  agile software development?}\\*\\
...
\label{sec:effects}
Research Question 3: \emph{What are the effects of  metric use in
  industrial agile software development?}\\*\\
...
Research Question 4: \emph{What metrics are important in industrial
  agile software development?}\\*\\
...
\fixme{metateksti, tutkimuskysymykset tänne vai aliotsikoihin.}
...
\section{Important metrics? Common metrics? wtf}
\fixme{otsikko}
...
\section{jotain sepitystä mittaroinnista, kohde vs tarkoitus importance}
\fixme{otsikko}
