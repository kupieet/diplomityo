...
industrial agile software development?}. Second, the metrics are categorized according
  ...
  total of 102 metrics were found in the primary studies.
...
\citetsrc{fenton1998software} in \Cref{tab:metricsCategorization}, measurement is focused towards Products and
Processes, but not Resources. This implies that measuring resources is not
important. One implication is that agile development assumes a capable team,
and that they can improve themselves. \citetsrc{boehm2003using} acknowledge
that agile projects require people with higher methodological skills than
plan-driven projects. Also, agile methods are used for simpler projects where
resource issues are simpler than in larger, more complex projects. Another
possibility is that measuring resources, especially people, can lead to
dysfunctional behaviour. Another observation is that almost any form of
documentation is not measured. Instead, the focus is on the actual product and
features which aligns with the agile principles, concentrating on the
software.
...
seen in this study. Metrics are a common tool for process improvement, but
maybe this type of creation of situative metrics is something new?
...
There were also reasons for metrics use that were not found in this study.
\emph{``Experimental validation of best practices''} \citep{312034} means
using metrics to decide if a practice is worth using or not. Agile teams seem
to be more focused on providing value for their customers so they do not focus
that much time formally evaluating work practices. Instead, they use informal,
qualitative, ways to assess work practices, for example in sprint
...
\emph{``The software development process should be designed by measurable
objectives, which leads to a precise definition of software quality
...
Regarding the found effects of metric use a quote from
\citetsrc{jones2008applied} can be compared: \emph{``The goal of applied
...
Important metrics are also identified: velocity, effort estimate, defect count
and customer satisfaction being top 4 in terms of amount of evidence and
described importance. This gives an idea what industrial agile teams are
interested in. It could be argued that they value planning (effort estimate) ,
progress tracking (velocity), pre-release quality (defect count) and
...
measure of progress - which was also seen in this study [S30]. However, a key
metric for business value a team should define with the business unit,
proposed by \citetsrc{1667571}, was not seen in this study. Furthermore,
\citetsrc{1667571} do not provide any specific agile metrics but rather
describe how agile metrics should be chosen and how they should be introduced
...
To evaluate the agility of the found metrics and their use, the findings are
...
development. This study categorizes metrics found in empirical agile studies
and compares the found metrics with the metrics suggested by agile literature.
...
and the negative effects of metric use can be an interesting future research
topic.
