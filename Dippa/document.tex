...
I wish to thank all students who use \LaTeX\ for formatting their
theses, because theses formatted with \LaTeX\ are just so nice.
...
\bibliographypri{sources}

\nobibliography{sources_p}


\input{PrimaryStudies}
