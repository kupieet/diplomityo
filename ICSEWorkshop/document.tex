...
There are a few mapping studies on software metrics(tï¿½hï¿½n vois lisï¿½tï¿½ kitch
whats 2010:ssï¿½ olevat muut mut en tiiï¿½ mitï¿½ lisï¿½arvoa ne tois).
...
(Tï¿½hï¿½n ehkï¿½ kai tyyliin et vï¿½hï¿½n etitty et lï¿½ytykï¿½ mitï¿½ï¿½n laajaa tutkimusta
agile mittareista) (Tï¿½ssï¿½ voisi myï¿½s perustella vielï¿½ SR:n valitsemista
menetelmï¿½ksi -Why SR was selected? This is more a ï¿½understanding of problemï¿½
...
\hline \textbf{Publication channel} & \textbf{Type} & \textbf{Number} &
\textbf{Percent}\\
\hline 
\end{tabular}
...
\textbf{ID}&\textbf{Research method}&\textbf{Agile method}&\textbf{Domain}\\
\hline \cite{Cataldo2011161} & Singlecase & FDDScrumMix & Navigation system
for automobiles\\
\hline \cite{Cheng200929} & Multicase &  NA / Scrum / Scrum & ERP / Graphic
design plug-in / Facility management\\
\hline \cite{Elssamadisy2002617} & Single-experience & XP & Enterprise
resource solution for the leasing industry \\
\hline \cite{Mujtaba2010139} & Singlecase & ScrumXPMix & Telecom
\\
\hline \cite{Petersen2011975} & Singlecase & ScrumXPMix & Telecom \\
\hline \cite{Petersen2010654} & Singlecase & AgileMix & Telecom \\
\hline \cite{Seikola2011321} & Singlecase & ScrumBan & Telecom maintenance \\
\hline \cite{Shen200725} & Singlecase & ScrumXPMix & Independent software
developer \\
\hline \cite{Talby2006100} & Singlecase & XPMix & Enterprise information
system \\
\hline \cite{Staron20101069} & Singlecase & LeanMix & Telecom \\
\hline \cite{Staron20113} & Singlecase & LeanMix & Telecom \\
\hline \cite{Petersen20101275} & Singlecase & LeanMix  & Telecom \\
\hline \cite{Jakobsen2011168} & Singlecase & LeanScrumFDD & Information and
communication software development \\
\hline \cite{Janus20129} & Single-experience & XPMix & Web application
development\\
\hline \cite{Polk2011263} & Single-experience & ScrumXPLeanKanban & 
Casino games\\
\hline \cite{Talby200940} & Singlecase & XP & Enterprise information
system\\
\hline \cite{Trapa2006243} & Single-experience & ScrumXPMix & Telecom \\
\hline \cite{Green2011} & Survey & Scrum & Desktop and SaaS products \\
\hline \cite{Greening2010} & Single-experience & Scrum & NA \\
\hline \cite{Hodgetts2004106} & Multicase & XP / Scrum & Criminal justice
system development / b-2-b e-commerce solutions \\
\hline \cite{Mahnic201273} & Singlecase & Scrum & Web page development \\
\hline \cite{Trimble20134826} & Singlecase & ScrumMix & Space mission control
software \\
\hline \cite{LNBIP01490121} & Single-experience & Scrum & Software for oil and
gas industry \\
\hline \cite{Petersen2012108} & Singlecase & LeanMix & Telecom \\
\hline \cite{Middleton2007387} & Singlecase & Lean & Various \\ \hline
\end{tabular}
\end{table*}
...
are only checked in certain intervals(ei oo muistissa viitettï¿½ tï¿½hï¿½n). In some
cases there are defined limits in metrics that trigger improvement actions(en
muista viitettï¿½ tï¿½hï¿½n).
...
code presented to the customer(viite, ja pitï¿½is lisï¿½tï¿½ resultteihinkin ellei
jo ole siellï¿½).
...
(toinen judu mitï¿½ tï¿½ï¿½llï¿½ voisi olla niin vertailu perinteisiin tai
agiilikirjallisuudessa suositeltuihin)
(kolmas judu: Koodimittarit oli aika heikosti edustettuna - vain muutama.
Joka on sinänsä mielenkiintoista koska tutkimuksissa ne on hyvin
edustettuna(kai). ))
()
