...
There are a few mapping studies on software metrics(t‰h‰n vois lis‰t‰ ne kitch
...
primary documents and some context info.
...
are only checked in certain intervals(ei oo muistissa viitettÔøΩ tÔøΩhÔøΩn). In some
cases there are defined limits in metrics that trigger improvement actions(en
muista viitettÔøΩ tÔøΩhÔøΩn).
...
Viite mista principlet tulee. Joka principlen kohdalta ensin mika sita tukee.
 ...
 Lisaksi principlet jarjestykseen. Ja lopuksi mille principlelle ei ollut mittareita.
  -> Future work Pitaisiko olla ja millaisia}
...
\eetu{Principle 2:een en keksi oikeen mit‰‰n. Ainoastaan Help decision
making vaikuttais v‰h‰n osuvan mut ei ehk‰ tarpeeksi.}
...
\cref{sec:Motivate} and \cref{sec:IterationTracking}. \eetu{tasta olisi
myos ehdotuksia Mujtabassa market unitin ja business unitin yhteistyo
mutta ei nayttoa etta nain olisi tehty.}%Also, the use of waste identification
% metrics in \cite{Mujtaba2010139} lead to
...
and good design enhances agility.'' \eetu{Lisaan tahan build broken ja
technical debt ainakin.}
...
TODO: Finally, we found that Agile principles x, y, z, were not reflected in
any metric. TODO Some reasons for this.



\subsection{Implications for research}
No code metrics present....
