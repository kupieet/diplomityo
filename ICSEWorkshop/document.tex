...
\begin{tabular}{lllllp{3cm}p{5cm}} \hline
ID & Year & Resear. meth. & Agile method & Team size & Domain & Metrics\\
\hline \cite{Cheng200929} & 2009 & Multicase &  NA/Scrum/Scrum & 2-10/2-7/4-8
...
Information and communication software development & Fix time of failed
...
\nameref{sec:PreQuality} &
\cite{Janus20129}\cite{Janus20129}\cite{Dubinsky200512}\cite{Trapa2006243}\\
...
\cite{Elssamadisy2002617}. One non-numerical progress metric was product
...
\cite{Janus20129}. Moreover, metrics were used to make sure that the product is sufficiently tested before the next step in the
...
\cite{Petersen2010654}\cite{Green2011}\cite{Cheng200929} while other metrics
used pre-release data as predictors of external quality
\cite{Staron20101069}\cite{Petersen2010654}\cite{Green2011}. Customer related
...
Changes to requirements managements were also made based on metrics in
...
takes to fix it \cite{LNBIP01490121}\cite{Jakobsen2011168}\cite{Janus20129}.
...
progress measure. However, some other measures from \cref{sec:IterationTracking} show that instead of working code agile teams
followed completed tasks and velocity metrics.
